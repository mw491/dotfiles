...
myBrowser :: String
myBrowser = "google-chrome "  -- Sets default browser

myEmacs :: String
myEmacs = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myEditor :: String
myEditor = "gvim "  -- Sets emacs as editor
...
myStartupHook = do
    ...
    spawnOnce "lxsession"
    spawnOnce "killall lxsession lxpanel io.elementary.wingpanel plank conky"
    spawnOnce "picom --config $HOME/.config/picom/picom.conf"
    spawnOnce "nm-applet"
    spawnOnce "volumeicon"
    spawnOnce "/usr/bin/emacs --daemon" -- emacs daemon for the emacsclient

    -- spawn ("sleep 2 && conky -c $HOME/.config/conky/xmonad/" ++ "mydracula" ++ "-01.conkyrc")
    spawn ("sleep 2 && trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 " ++ colorTrayer ++ " --height 24 --distance 3")

    -- spawnOnce "xargs xwallpaper --stretch < ~/.cache/wall"
    -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
    -- spawnOnce "feh --randomize --bg-fill ~/wallpapers/*"  -- feh set random wallpaper
    spawnOnce "nitrogen --restore &"   -- if you prefer nitrogen to feh
    spawnOnce "./sleepidle.sh"
    spawnOnce "flameshot"
    setWMName "LG3D"
...
myAppGrid =  [ ("Terminal", "gnome-terminal")
...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " vbox ", " chat ", " game ", " vid ", " gfx "]
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
	  ...
	  -- , ("M-S-<Return>", spawn "dmenu_run -i -nf red -sb darkblue -p \"Run: \"") --Dmenu
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        ...
        -- , ("M-a", spawn("~/.config/rofi/bin/launcher_ribbon"))
        , ("M-a", spawn("dmenu_run -c -g 4 -l 17"))
        , ("M-d", spawn("pcmanfm"))
        , ("C-M1-<Return>", spawn("telegram-desktop"))
        , ("M-w", spawn("~/Applications/LibreWolf.AppImage"))
        , ("M-S-s", spawn("flameshot gui"))
        , ("M-<Escape>", spawn("systemctl suspend"))
		    , ("M-S-<Escape>", spawn("./power.sh"))
